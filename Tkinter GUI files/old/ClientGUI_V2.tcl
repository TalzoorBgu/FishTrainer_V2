...
#  Jul 23, 2019 01:21:13 PM IDT  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 891x800+238+53
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button $site_3_0.but39 \
        ...
        -highlightcolor black -pady 0 -text {Run traning} 
    ...
    text $site_3_0.tex79 \
        ...
        -width 218 -wrap word 
    .top37.fra38.tex79 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    .top37.fra38.tex79 insert end text
    vTcl:DefineAlias "$site_3_0.tex79" "txtArgs" vTcl:WidgetProc "MainGUI" 1
    label $site_3_0.lab80 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Arguments 
    ...
    button $site_3_0.but38 \
        ...
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text {Stop traning} 
    ...
    text $site_3_0.tex45 \
        ...
        -wrap word 
    .top37.fra38.tex45 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    text $site_3_0.tex46 \
        ...
        -wrap word 
    .top37.fra38.tex46 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    text $site_3_0.tex42 \
        ...
        -selectbackground {#c4c4c4} -selectforeground black -undo 1 -width 90 \
        -wrap word 
    .top37.fra38.tex42 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    text $site_3_0.tex43 \
        ...
        -selectbackground {#c4c4c4} -selectforeground black -undo 1 -width 82 \
        -wrap word 
    .top37.fra38.tex43 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    button $site_3_0.but56 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onStatRun -font TkDefaultFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
    ...
    text $site_3_0.tex40 \
        ...
        -wrap word 
    .top37.fra52.tex40 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    label $site_3_0.lab41 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Arg. 
    ...
    text $site_3_0.tex42 \
        ...
        -wrap word 
    .top37.fra52.tex42 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    text $site_3_0.tex46 \
        ...
        -selectbackground {#c4c4c4} -selectforeground black -undo 1 \
        -width 442 -wrap word 
    .top37.fra52.tex46 configure -font "-family {.AppleSystemUIFont} -size 20 -weight bold"
    ...
    vTcl::widgets::ttk::scrolledtreeview::CreateCmd $site_4_0.scr53 \
        -relief groove -background {#d9d9d9} -height 153 \
        -highlightbackground {#d9d9d9} -highlightcolor black -width 510 
    vTcl:DefineAlias "$site_4_0.scr53" "DB" vTcl:WidgetProc "MainGUI" 1
        ...
        .top37.fra52.fra44.scr53.01 column #0 -width 248
        ...
        .top37.fra52.fra44.scr53.01 column Col1 -width 248
    ...
    place $site_4_0.scr53 \
        -in $site_4_0 -x 10 -y 10 -width 510 -relwidth 0 -height 153 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.but56 \
        -in $site_3_0 -x 704 -y 223 -width 141 -relwidth 0 -height 38 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab76 \
        -in $site_3_0 -x 312 -y 8 -width 89 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab39 \
        -in $site_3_0 -x 80 -y 230 -width 77 -height 24 -anchor nw \
        -bordermode ignore 
    place $site_3_0.tex40 \
        -in $site_3_0 -x 160 -y 230 -width 66 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab41 \
        -in $site_3_0 -x 248 -y 230 -anchor nw -bordermode ignore 
    place $site_3_0.tex42 \
        -in $site_3_0 -x 288 -y 230 -width 74 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.tex46 \
        -in $site_3_0 -x 400 -y 8 -width 442 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.fra44 \
        -in $site_3_0 -x 10 -y 40 -width 845 -relwidth 0 -height 175 \
        -relheight 0 -anchor nw -bordermode ignore 
    frame $top.fra57 \
    ...
    button $site_3_0.but61 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onSendtest -font TkDefaultFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text {Send test} 
    ...
    checkbutton $site_3_0.che41 \
        ...
        -text {Red Feeder} -variable chb_Var -wraplength 35 
    ...
    label $site_3_0.lab42 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Vel 
    vTcl:DefineAlias "$site_3_0.lab42" "Label7_3" vTcl:WidgetProc "MainGUI" 1
    label $site_3_0.lab43 \
        -activebackground {#f9f9f9} -activeforeground black \
        -background {#d9d9d9} -font TkDefaultFont -foreground {#000000} \
        -highlightbackground {#d9d9d9} -highlightcolor black -text Accl 
    ...
    label $site_3_0.lab39 \
        ...
        -foreground {#0000fe} -highlightbackground {#d9d9d9} \
        -highlightcolor black -text 00:00 
    ...
    ###################
    place $top.fra38 \
        -in $top -x 10 -y 380 -width 864 -relwidth 0 -height 131 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but41 \
        -in $top -x 696 -y 762 -width 177 -relwidth 0 -height 30 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra52 \
        -in $top -x 10 -y 10 -width 864 -relwidth 0 -height 267 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra57 \
        -in $top -x 10 -y 280 -width 864 -relwidth 0 -height 91 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.fra71 \
        -in $top -x 10 -y 520 -width 861 -relwidth 0 -height 235 -relheight 0 \
        -anchor nw -bordermode ignore 
