...
#  Mar 09, 2020 02:25:13 PM IST  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 880x748+321+67
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    text $site_3_0.tex43 \
        ...
        -insertbackground black -selectbackground {#c4c4c4} \
        -selectforeground black -width 218 -wrap word 
    .top37.fra52.tex43 configure -font "TkTextFont"
    .top37.fra52.tex43 insert end text
    vTcl:DefineAlias "$site_3_0.tex43" "txtConfigFile" vTcl:WidgetProc "MainGUI" 1
    button $site_3_0.but44 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -command onShowConfigFile -font TkDefaultFont \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -text Show 
